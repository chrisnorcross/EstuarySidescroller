...
// Tests Player and Character Class
	...
	public void testToString(){
		...
		/*	
	  	...
	  	*/
		///*p1.toString();
		assertEquals("Test to see if model is X (Player)","This player at location 360, their score is 0, and they have 10 hit points." ,p1.toString());
		p1.eatFood();
		p1.changeScore(100);
		p1.eatFood();
		p1.changeScore(100);
		...
		p1.jumpUp();
		p1.Move();
		assertEquals("Test to see if model is X (Player)","This player at location 180, their score is 200, and they have 10 hit points." ,p1.toString());
		p1.jumpDown();
		p1.jumpDown();
		p1.jumpDown();
		p1.Move();
		...
		p1.getScore();
		p1.getHealth();
		assertEquals("Test to see if model is X (Player)","This player at location 720, their score is 200, and they have 5 hit points." ,p1.toString());
		p1.jumpDown();
		p1.Move();
		p1.eatFood();
		p1.changeScore(100);
		p1.getScore();
		assertEquals("Test to see if model is X (Player)","This player at location 720, their score is 300, and they have 5 hit points." ,p1.toString());
		p1.takeDamage(-5);
		p1.changeScore(-100);
		p1.getHealth();
		System.out.println(p1.toString());
		assertEquals("Test to see if model is X (Player)","This player at location 720, their score is 200, and they have 0 hit points." ,p1.toString());
	//*/
	}
	...
	public void testGetXLoc(){
		Player p1 = new Player();
		assertEquals("Test Starting X Location of Player",Main.frameWidth - (Main.frameWidth-Main.frameWidth/12),p1.getXloc());
