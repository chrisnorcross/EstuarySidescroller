 ...
 * screen make sure the values for frameWidth and frameHeights EXAMPLE: public
 * static int frameWidth;// = 700; //delete the = 700 public static int
 * frameHeight;// = 500; //delete the = 500 ALSO COMMENT OUT THE
 * screenSize.getHeight/Width
 * 
 * 
...
public class Main {
	...
	public static int frameWidth = 1440;// = 700; //delete unless partial
										// screen// keep for testing
	public static int frameHeight = 900;// = 500; //delete unless partial
										// screen// keep for testing
